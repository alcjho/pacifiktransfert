                    ...
                    <div className="featured-boxes-inner">
                        <div className="row m-0">
                            {/* {homeInfo.feature_1_title && */}
                                <div className="col-lg-3 col-sm-6 col-md-6 p-0">
                                    <div className="single-featured-box">
                                        <img src={process.env.BACKEND_URL + homeInfo.reason1_icon?.data.attributes.url} className="single-featured-box-icon mb-3" alt="image" />
                            ...
                            {/* {homeInfo.feature_2_title && */}
                                <div className="col-lg-3 col-sm-6 col-md-6 p-0">
                                    <div className="single-featured-box">
                                        <img src={process.env.BACKEND_URL + homeInfo.reason2_icon?.data.attributes.url} className="single-featured-box-icon mb-3" alt="image" />
                            ...
                            {/* {homeInfo.feature_3_title &&  */}
                                <div className="col-lg-3 col-sm-6 col-md-6 p-0">
                                    <div className="single-featured-box">
                                        <img src={process.env.BACKEND_URL + homeInfo.reason3_icon?.data.attributes.url} className="single-featured-box-icon mb-3" alt="image" />
                            ...
                            {/* {homeInfo.feature_4_title &&  */}
                                <div className="col-lg-3 col-sm-6 col-md-6 p-0">
                                    <div className="single-featured-box">
                                        <img src={process.env.BACKEND_URL + homeInfo.reason4_icon?.data.attributes.url} className="single-featured-box-icon mb-3" alt="image" />
